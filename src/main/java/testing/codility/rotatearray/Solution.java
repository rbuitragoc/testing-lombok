...
public class Solution extends ArrayHelper {
    ...
    public static void main(String ... args) {
        int min = 0, max = 100, k = 1320;
            //ThreadLocalRandom.current().nextInt(min, max);
        int[] input = IntStream.generate(()-> {return ThreadLocalRandom.current().nextInt(-1000, 1000);}).limit(max).toArray();
            //new int[]{1,2,3,4,5,6,7};//generateRandomPrimitiveIntArray(100, -1000, 1000);
